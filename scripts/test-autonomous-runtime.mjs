...
assert.match(index, /Adaptive strategy 65 · policy-aware research · build 157/);
...
assert.match(workflow, /EXPECTED_BUILD: "157"/);
...
assert.match(index, /const BUNDLE_DEPTH_CANDIDATE_LIMIT=300;/);
