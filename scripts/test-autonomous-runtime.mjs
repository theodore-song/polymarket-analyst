...
assert.match(index, /Adaptive strategy 65 · live 72h allocation fix · build 150/);
...
assert.match(index, /fiveBalancedPositiveEventsStartTinyProbation:/);
assert.match(index, /singleLargeDownsideBlocksEarlyProbation:/);
assert.match(index, /oneOutlierCannotCreateProbation:/);
assert.match(index, /probationSizingSurvivesCloudCompaction:/);
assert.match(index, /probationCapIncludesOppositeDirection:/);
...
assert.match(workflow, /EXPECTED_BUILD: "150"/);
