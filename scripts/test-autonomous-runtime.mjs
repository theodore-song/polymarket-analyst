...
assert.match(index, /Adaptive strategy 65 · faster protected learning · build 142/);
...
assert.match(workflow, /EXPECTED_BUILD: "142"/);
...
assert.match(index, /function manageBundleMakerQuotes\(st,\{executeTrades=false,touchHistory=\{\},booksOverride=null,reportedFeesOverride=null\}=\{\}\)/);
