...
assert.match(index, /Adaptive strategy 65 · reward-aware maker research · build 147/);
...
assert.match(index, /const SHOCK_FADE_PROBATION_POSITION_PCT=0\.001;/);
assert.match(index, /const SHOCK_FADE_PROBATION_TOTAL_CAPITAL_PCT=0\.005;/);
...
assert.match(workflow, /EXPECTED_BUILD: "147"/);
