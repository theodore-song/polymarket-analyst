...
assert.match(index, /Adaptive strategy 65 · evidence-scaled capital · build 155/);
...
assert.match(workflow, /EXPECTED_BUILD: "155"/);
...
assert.match(index, /const BUNDLE_MAKER_STRATEGY_VERSION = 5;/);
