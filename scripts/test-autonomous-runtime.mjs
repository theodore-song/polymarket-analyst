...
assert.match(index, /Adaptive strategy 65 · risk-budgeted maker fills · build 137/);
...
assert.match(workflow, /EXPECTED_BUILD: "137"/);
...
assert.match(index, /const BUNDLE_MAKER_STRATEGY_VERSION = 2;/);
