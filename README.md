...
Build 110 runs the headless GitHub Actions runtime every five minutes, continues
...
Each Build 110 cycle also scans the 1,000 most-active Polymarket events for
...
Build 110 retains the directional learner's exact-fee policy, which replaced the blanket half-cent cost with
...
Build 110 retains Build 100's retirement of the old 3-6 day resolution-window
...
reliable confidence bound, so Build 110 no longer allocates capital to that rule.
